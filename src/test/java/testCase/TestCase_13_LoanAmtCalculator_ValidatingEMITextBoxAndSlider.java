...
public class TestCase_13_LoanAmtCalculator_ValidatingEMITextBoxAndSlider extends BaseClass 
{
	...
	public void validatingEMITextBoxAndSlider() 
	{
		...
		catch(Exception e) 
		{
			...
			System.out.println("TestCase_13_LoanAmtCalculator_ValidatingEMITextBoxAndSlider got failed, validation of EMI Text Box was unsuccessful");
			
			logger.error("TestCase_13_LoanAmtCalculator_ValidatingEMITextBoxAndSlider got failed, validation of EMI Text Box was not successful");
			myAssert.fail();
		}
