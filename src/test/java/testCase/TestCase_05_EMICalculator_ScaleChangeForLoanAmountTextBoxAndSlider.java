...
public class TestCase_05_EMICalculator_ScaleChangeForLoanAmountTextBoxAndSlider extends BaseClass{
	...
	public void validatingDataFlowBetweenLoanAmountSliderAndTextBox() {
		...
		try {
			...
			System.out.println("TestCase_05_EMICalculator_ScaleChangeForLoanAmountTextBoxAndSlider got failed, Scale Check for Loan Amount Text Box and Slider was unsuccessful");
			
			logger.error("TestCase_05_EMICalculator_ScaleChangeForLoanAmountTextBoxAndSlider got failed, Scale check for Loan Amount Text Box and Slider was not successful");
			myAssert.fail();
		}
		
		logger.info("---- TestCase_05_EMICalculator_ScaleChangeForLoanAmountTextBoxAndSlider Ended ----");
	}
}
