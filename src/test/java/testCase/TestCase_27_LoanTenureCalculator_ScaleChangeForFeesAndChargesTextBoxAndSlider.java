...
public class TestCase_27_LoanTenureCalculator_ScaleChangeForFeesAndChargesTextBoxAndSlider extends BaseClass{
	...
	public void validatingDataFlowBetweenFeesAndChargesSliderAndTextBox() {
		...
		try {
			...
			logger.error("TestCase_27_LoanTenureCalculator_ScaleChangeForFeesAndChargesTextBoxAndSlider got failed, Scale Change for Fees And Charges Text Box ans Slider was not successful");
			myAssert.fail();
		}
