...
public class TestCase_19_LoanAmtCalculator_ValidationForYearAndMonthOption extends BaseClass{
	...
	public void validatingDataFlowBetweenYearAndMonthButton() {
		...
		try {
			...
			System.out.println("TestCase_19_LoanAmtCalculator_ValidationForYearAndMonthOption got failed, Validation for Year and Month Button was unsuccessful");
			
			logger.error("TestCase_19_LoanAmtCalculator_ValidationForYearAndMonthOption got failed, Validation for Year and Month Button was not successful");
			myAssert.fail();
		}
