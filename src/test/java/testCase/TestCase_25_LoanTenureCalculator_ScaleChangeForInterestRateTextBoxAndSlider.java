...
public class TestCase_25_LoanTenureCalculator_ScaleChangeForInterestRateTextBoxAndSlider extends BaseClass{
	...
	public void validateDataFlowBetweenInterestRateSliderAndTextBox() {
		...
		try {
			...
			logger.error("TestCase_25_LoanTenureCalculator_ScaleChangeForInterestRateTextBoxAndSlider got failed, Scale Change for Interest Rate Text Box and Slider was unsuccessful");
			myAssert.fail();
		}
