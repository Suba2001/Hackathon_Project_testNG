...
public class TestCase_12_EMICalculator_ValidationForYearAndMonthOption extends BaseClass{
	...
	public void validatingDataFlowBetweenYearAndMonthButton() {
		...
		try {
			...
			System.out.println("TestCase_12_EMICalculator_ValidationForYearAndMonthOption got failed, Validation for Year and Month Button was unsuccessful");
			
			logger.error("TestCase_12_EMICalculator_ValidationForYearAndMonthOption got failed, Validation for Year and Month Button was not successful");
			myAssert.fail();
		}
