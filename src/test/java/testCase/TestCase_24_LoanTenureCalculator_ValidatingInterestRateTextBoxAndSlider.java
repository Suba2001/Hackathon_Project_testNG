...
public class TestCase_24_LoanTenureCalculator_ValidatingInterestRateTextBoxAndSlider extends BaseClass{
	...
	public void validateInterestRateTextBoxAndSlider() {
		...
		try {
			...
			System.out.println("TestCase_24_LoanTenureCalculator_ValidatingInterestRateTextBoxAndSlider got failed, validation of Interest Rate Text Box was unsuccessful");
			
			logger.error("TestCase_24_LoanTenureCalculator_ValidatingInterestRateTextBoxAndSlider got failed, validation of Interest Rate Text Box was not successful");
			myAssert.fail();
		}
